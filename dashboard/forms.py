...
class OffreDEmploiForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'titre_poste': forms.TextInput(attrs={'class': 'form-control', 'id': 'id_titre_poste','style':'height:80px;'}),
            'description': forms.Textarea(attrs={'class': 'form-control', 'id': 'id_description', 'placeholder': 'Description','style':'height:80px;'}),
            'date_publication_present': forms.DateInput(attrs={'class': 'form-control', 'id': 'id_date_publication_present', 'placeholder': 'Date de Publication','style':'height:80px;'}),
            'date_limite_candidature': forms.DateInput(attrs={'class': 'form-control', 'id': 'id_date_limite_candidature', 'placeholder': 'Date Limite de Candidature','style':'height:80px;'}),
            'competence': forms.TextInput(attrs={'class': 'form-control', 'id':'id_competence' ,'placeholder': 'competence','style':'height:80px;'}),
            'salaire_propose': forms.NumberInput(attrs={'class': 'form-control', 'id': 'id_salaire_propose', 'placeholder': 'Salaire Proposé','style':'height:80px;'}),
